...
export const BUILT_IN_EXERCISES: Record<string, ExerciseDef> = {
  ...
  // Överslag räck – 13 KFs importerade från studion. Full varv runt stången
  // (rootRotX 0 → 5.70) med hänglåsta händer; ett toppläge (t≈0.5–0.875)
  // håller gymnasten stående på stången innan retur-varvet. Symmetrisk
  // kurva: KFs efter toppen speglar kurvan dit.
  "high-bar:overslag": {
    lockMode: "hands",
    kfs: [
      { t: 0, pose: { ...HANG_STRAIGHT,
        lShX: 3.13681469282041, rShX: 3.13681469282041,
        rootY: -0.03 } },
      { t: 0.125, pose: { ...ZERO,
        lShX: 0.876814692820414, lElX: 2.26681469282041,
        rShX: 0.876814692820414, rElX: 2.26681469282041,
        lHipX: 0.366814692820414, rHipX: 0.366814692820414,
        rootY: 0.4114025174145616, rootZ: 0.1985906071976805 } },
      { t: 0.25, pose: { ...ZERO,
        spineX: -1.17318530717959,
        lShX: -0.293185307179586, lElX: 1.38681469282041,
        rShX: -0.293185307179586, rElX: 1.38681469282041,
        rootY: 0.7706626375258996, rootZ: -0.08230862813855386,
        rootRotX: 3.21681469282041 } },
      { t: 0.5, pose: { ...ZERO,
        spineX: -0.803185307179586,
        lShX: -0.583185307179586, lElX: 1.75681469282041,
        rShX: -0.583185307179586, rElX: 1.75681469282041,
        lHipX: 0.366814692820414, rHipX: 0.366814692820414,
        rootY: 0.9758818605748143, rootZ: -0.1,
        rootRotX: 3.94681469282041 } },
      { t: 0.75, pose: { ...ZERO,
        spineX: -1.53318530717959,
        lShX: -0.803185307179586, lElX: 1.97681469282041,
        rShX: -0.803185307179586, rElX: 1.97681469282041,
        lHipX: 0.366814692820414, rHipX: 0.366814692820414,
        rootY: 1.0168238889890557, rootZ: 0.05955315355744975,
        rootRotX: 5.69681469282041 } },
      { t: 1, pose: { ...ZERO,
        spineX: -0.143185307179586,
        lShX: 0.366814692820414, lElX: -0.143185307179586,
        rShX: 0.366814692820414, rElX: -0.143185307179586,
        lHipX: 0.366814692820414, rHipX: 0.366814692820414,
        rootY: 1.091473863797476, rootZ: 0.03203896753721411,
        rootRotX: 5.69681469282041 } },
      { t: 1.25, pose: { ...ZERO,
        spineX: 0.216814692820414,
        lShX: 0.296814692820414, lElX: -0.143185307179586,
        rShX: 0.296814692820414, rElX: -0.143185307179586,
        lHipX: 0.366814692820414, rHipX: 0.366814692820414,
        rootY: 1.0591389986791966, rootZ: 0.04829400866091493,
        rootRotX: 5.69681469282041 } },
      { t: 1.5, pose: { ...ZERO,
        spineX: 0.216814692820414,
        lShX: 0.296814692820414, lElX: -0.143185307179586,
      ...
      { t: 2.5, pose: { ...ZERO,
        spineX: -0.803185307179586,
        lShX: 0.296814692820414, lElX: 0.506814692820414,
        rShX: 0.296814692820414, rElX: 0.506814692820414,
        lHipX: 0.366814692820414, rHipX: 0.366814692820414,
        rootY: 0.8495337347301488, rootZ: -0.28,
        rootRotX: 3.94681469282041 } },
      { t: 3, pose: { ...ZERO,
        spineX: -1.17318530717959,
        lShX: 0.656814692820414, rShX: 0.656814692820414,
        rootY: 0.5997101343275248, rootZ: -0.13425590478873997,
        rootRotX: 3.21681469282041 } },
      { t: 3.5, pose: { ...HANG_STRAIGHT,
        lShX: 3.13681469282041, rShX: 3.13681469282041,
        rootY: -0.03 } },
      { t: 3.75, pose: { ...HANG_STRAIGHT,
        lShX: 3.13681469282041, rShX: 3.13681469282041,
        rootY: -0.03 } },
    ],
  },
  ...
  // Språng – 7 KFs från studion. Huk → flygläge (armar upp, höger ben bak,
  // vänster ben fram) → tre flyg-KFs som sveper kroppen framåt ~1.6 m i
  // luften → landnings-huk → upprätt. rootZ-förflyttning totalt ~2 m.
  "floor:leap": { kfs: [
    { t: 0, pose: { ...ZERO } },
    { t: 0.25, pose: { ...ZERO,
    ...
    { t: 0.625, pose: { ...ZERO,
      ...
      lHipX: 0.366814692820414, rHipX: 0.366814692820414,
      lKnX: -0.953185307179586, rKnX: -0.953185307179586,
      rootY: -0.011883865276343268, rootZ: -1.95,
      rootRotX: 0.216814692820414 } },
    { t: 0.75, pose: { ...ZERO,
      rootZ: -2.02 } },
  ] },
